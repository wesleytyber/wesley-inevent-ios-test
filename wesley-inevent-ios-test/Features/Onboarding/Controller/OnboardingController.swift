...
extension OnboardingController: Controller {
    ...
    func configureRequets() {
        onboardingViewModel.getOnboardingInfo()
    }
...
extension OnboardingController: GenericDelegate {
    ...
    func tappedButton(_ view: UIView) {
        let nextIndex = min((onboardingView.onboardingViewPageControl.currentPage) + 1, (onboardingViewModel.onboardingModel.count) + 1)
...
extension OnboardingController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        onboardingView.onboardingViewPageControl.numberOfPages = onboardingViewModel.count
        return onboardingViewModel.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configureCell(data: onboardingViewModel.indexPath(indexPath: indexPath))
        return cell
    }
